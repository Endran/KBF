...
public class GetAllSummariesQuery implements Query {
	...
	public GetAllSummariesQuery(final int festivalBeerId) {
	...
	public QueryContainer getQuery() {
		...
		if (festivalBeerId >= 0) {
			queryContainer.selection = TableHelper.TABLE_FESTIVAL_BEER.COLUMN_REMOTE_ID + "=?";
			queryContainer.selectionArgs = new String[] { String.valueOf(festivalBeerId) };
		}
