...
import nl.endran.showcase.application.kbf.fragments.presenter.FestivalFragment;
...
public class MainActivity extends BaseShowcaseActivity {
	...
	private void initializeFragments() {
		...
		fragmentArray.put(0, new Pair<Fragment, String>(new FestivalFragment(), getString(R.string.festivalFragmentName)));
		fragmentArray.put(1, new Pair<Fragment, String>(new AllSummariesFragment(), getString(R.string.allSummariesFragmentName)));
		fragmentArray.put(2, new Pair<Fragment, String>(new AllBrewersFragment(), getString(R.string.allBrewersFragmentName)));
		fragmentArray.put(3, new Pair<Fragment, String>(new AllFavoriteSummariesFragment(), getString(R.string.allFavoriteSummariesFragmentName)));
		fragmentArray.put(4, new Pair<Fragment, String>(new AllWishListSummariesFragment(), getString(R.string.allWishListSummariesFragmentName)));
	}
}