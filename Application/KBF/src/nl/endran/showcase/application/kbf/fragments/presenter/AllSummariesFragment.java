...
public class AllSummariesFragment extends BaseSummariesFragment {

	@Override
	protected void getSummaries(final ShowcaseLibrary showcaseLibrary, final SummariesFragmentView summariesFragmentView) {
		showcaseLibrary.getDataAccess().getAllSummariesAndCurrentUserRatings(new GetAllSummariesAndCurrentUserRatingsListener() {
			...
			public void onSummariesAndRatings(final List<Summary> summaries, final List<UserBeer> userBeers) {
				AllSummariesFragment.this.summaries = summaries;
